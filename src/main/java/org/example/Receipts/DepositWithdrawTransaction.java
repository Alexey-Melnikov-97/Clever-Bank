...
/**
 * Класс для создания банковских чеков.
 */
public class DepositWithdrawTransaction {
    ...
    public DepositWithdrawTransaction() throws SQLException {
    }

    /**
     * Создает чек для пополнения счета или снятия наличных и сохраняет его в текстовом формате.
     *
     * @param transaction     тип транзакции (пополнение счета или снятие наличных)
     * @param sendersAccount  номер счета отправителя
     * @param amount          сумма
     * @throws SQLException если возникают проблемы при работе с базой данных
     */
    ...
    /**
     * Создает чек для перевода средств и сохраняет его в текстовом формате.
     *
     * @param transaction     тип транзакции (перевод средств)
     * @param sendersBank     банк отправителя
     * @param payeesBank      банк получателя
     * @param sendersAccount  номер счета отправителя
     * @param payeesAccount   номер счета получателя
     * @param amount          сумма
     * @throws SQLException если возникают проблемы при работе с базой данных
     */
